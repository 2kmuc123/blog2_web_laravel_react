...
export const Edit = () => {
    ...
    const [checkchang, setCheckchang] = useState(false);
    //lấy dữ liệu từ api
    useEffect(() => {
    ...
    useEffect(() => {
        if (checkchang) {
            setLoading(true)
            fetch(`/api/blog/update/${params.id}`, {
                method: 'PATCH',
                headers: {
        ...
        <div className='form-group'>
            ...
            <form onSubmit={handleForm}>
                ...
                <div className="form-group">
                    ...
                    <textarea className="row" name="content1" value={form.content1} id="" cols="150" rows="10" onChange={handleChangle}></textarea>

                </div>
                <div className="form-group">
                    <label htmlFor="exampleInputPassword1">Content2</label>
                    <textarea className="row" name="content2" id="" value={form.content2} cols="150" rows="10" onChange={handleChangle}></textarea>

                </div>
                <div className="form-group">
                    <label htmlFor="exampleInputPassword1">Content3</label>
                    <textarea className="row" name="content3" id="" cols="150" value={form.content3} rows="10" onChange={handleChangle}></textarea>
